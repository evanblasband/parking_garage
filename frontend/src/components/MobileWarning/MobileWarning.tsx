...
export function MobileWarning() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-ussf-navy flex items-center justify-center p-8">
      <div className="text-center max-w-md">
        {/* Icon */}
        <div className="w-24 h-24 rounded-full bg-ussf-navy-light flex items-center justify-center mx-auto mb-6">
        ...
        {/* Message */}
        <h1 className="text-2xl font-bold text-white mb-3 font-[var(--font-headline)]">
        ...
        <div className="bg-ussf-navy-light rounded-lg p-4 text-sm">
          <div className="flex justify-between text-white/60 mb-2">
            <span>Your screen width</span>
            <span className="text-ussf-red font-semibold">{window.innerWidth}px</span>
          </div>
          <div className="flex justify-between text-white/60">
            <span>Required width</span>
            <span className="text-white font-semibold">{MIN_WIDTH}px</span>
          </div>
        </div>
