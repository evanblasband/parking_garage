  ...
  if (!garageState || !metrics) {
    return (
      <div className="space-y-4">
        <h2 className="text-lg font-semibold text-wc-gold mb-4">Operator Dashboard</h2>
  ...
  return (
    <div className="space-y-4">
      ...
      <MetricCard
        ...
        valueColor="text-wc-gold"
        icon={
          <svg className="w-5 h-5 text-wc-gold" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-wc-red/20 border border-wc-red/40 rounded-lg p-4">
        ...
        <div className="text-sm font-medium">
          {gameCountdown.isPast ? (
            <span className="text-wc-gold">Game in progress!</span>
          ) : (
            <>
              <span className="text-wc-white">Kickoff at </span>
              <span className="text-wc-gold">7:00 PM</span>
